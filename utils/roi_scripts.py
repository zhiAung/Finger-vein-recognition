...
def roi(rotated_img, rotated_edge, url):
    ...
    #leftest_edge = 0 
    rotated_edge[highest_edge, : ] = 100
    rotated_edge[lowest_edge, : ] = 150
    rotated_edge[: , leftest_edge] = 200
    rotated_edge[: , rightest_edge] = 250
